...
replace (
	...
	k8s.io/cli-runtime => github.com/k3s-vip/kubernetes/staging/src/k8s.io/cli-runtime v1.32.13-eol
	...
	k8s.io/cluster-bootstrap => github.com/k3s-vip/kubernetes/staging/src/k8s.io/cluster-bootstrap v1.32.13-eol
	k8s.io/code-generator => github.com/k3s-vip/kubernetes/staging/src/k8s.io/code-generator v1.32.13-eol
	...
	k8s.io/kube-aggregator => github.com/k3s-vip/kubernetes/staging/src/k8s.io/kube-aggregator v1.32.13-eol
	k8s.io/kube-controller-manager => github.com/k3s-vip/kubernetes/staging/src/k8s.io/kube-controller-manager v1.32.13-eol
	k8s.io/kube-proxy => github.com/k3s-vip/kubernetes/staging/src/k8s.io/kube-proxy v1.32.13-eol
	k8s.io/kube-scheduler => github.com/k3s-vip/kubernetes/staging/src/k8s.io/kube-scheduler v1.32.13-eol
	k8s.io/kubectl => github.com/k3s-vip/kubernetes/staging/src/k8s.io/kubectl v1.32.13-eol
	...
	k8s.io/legacy-cloud-providers => github.com/k3s-vip/kubernetes/staging/src/k8s.io/legacy-cloud-providers v1.32.13-eol
	k8s.io/metrics => github.com/k3s-vip/kubernetes/staging/src/k8s.io/metrics v1.32.13-eol
	k8s.io/mount-utils => github.com/k3s-vip/kubernetes/staging/src/k8s.io/mount-utils v1.32.13-eol
	k8s.io/pod-security-admission => github.com/k3s-vip/kubernetes/staging/src/k8s.io/pod-security-admission v1.32.13-eol
	k8s.io/sample-apiserver => github.com/k3s-vip/kubernetes/staging/src/k8s.io/sample-apiserver v1.32.13-eol
)
